...
if ( ! function_exists( 'mtm_scripts_styles' ) ) {
	function mtm_scripts_styles() {
		...
		wp_enqueue_style( 'fontawesome', MTM_OPTIONS_FILE_URL . 'css/fontawesome-all.min.css', false );
	}
}
...
if ( ! function_exists( 'mtm_customizer_preview_scripts' ) ) {
	function mtm_customizer_preview_scripts() {
		wp_enqueue_script( 'mtm-customizer-preview', MTM_OPTIONS_FILE_URL . 'js/customizer-preview.js', array( 'customize-preview', 'jquery' ) );
	}
}
...
function mtm_add_block_editor_assets() {
	wp_enqueue_style( 'customizer-styles', MTM_OPTIONS_FILE_URL . 'css/customizer-style.css', false );
}
