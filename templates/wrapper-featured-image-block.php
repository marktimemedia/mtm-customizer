...
<section class="mtm-grid--image <?php echo esc_attr( $classes ); ?>">
	<a aria-hidden="true" tabindex="-1" href="<?php the_permalink(); ?>"><figure class="post--thumbnail mtm-post-thumbnail has-background cropped" style="background-image:url(<?php echo esc_url( $url ); ?>)"></figure></a>
</section>
