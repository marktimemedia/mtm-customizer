...
class mtm_initialise_customizer_settings {
	...
	public function mtm_add_customizer_sections( $wp_customize ) {
		 ...
		 */
		$wp_customize->add_section( 'header_footer_section',
			array(
		 ...
		 */
		$wp_customize->add_section( 'special_pages_section',
			array(
	...
	public function mtm_register_font_controls( $wp_customize ) {
		...
		$wp_customize->add_setting( 'heading_font_select',
			array(
				'default' => $this->defaults['heading_font_select'],
				'sanitize_callback' => 'mtm_google_font_sanitization'
			)
		);
		$wp_customize->add_control( new Mtm_Google_Font_Select_Custom_Control( $wp_customize, 'heading_font_select',
			array(
		...
		// Test of Google Font Select Control
		$wp_customize->add_setting( 'subheading_font_select',
			array(
				'default' => $this->defaults['heading_font_select'],
				'sanitize_callback' => 'mtm_google_font_sanitization'
			)
		);
		$wp_customize->add_control( new Mtm_Google_Font_Select_Custom_Control( $wp_customize, 'subheading_font_select',
			array(
		...
		// Test of Google Font Select Control
		$wp_customize->add_setting( 'body_font_select',
			array(
				'default' => $this->defaults['body_font_select'],
				'sanitize_callback' => 'mtm_google_font_sanitization'
			)
		);
		$wp_customize->add_control( new Mtm_Google_Font_Select_Custom_Control( $wp_customize, 'body_font_select',
			array(
	...
	*/
	...
	public function mtm_register_social_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new Mtm_Toggle_Switch_Custom_control( $wp_customize, 'social_newtab',
			array(
		...
		$wp_customize->add_control( new Mtm_Sortable_Repeater_Custom_Control( $wp_customize, 'social_urls',
			array(
		...
		$wp_customize->add_control( new Mtm_Single_Accordion_Custom_Control( $wp_customize, 'social_url_icons',
			array(
		...
		$wp_customize->add_control( new Mtm_Toggle_Switch_Custom_control( $wp_customize, 'social_rss',
			array(
	...
	public function mtm_register_text_controls( $wp_customize ) {
		...
		// Header Text
		$wp_customize->add_setting( 'header_extra_text',
			array(
		...
		$wp_customize->add_control( new Mtm_TinyMCE_Custom_control( $wp_customize, 'header_extra_text',
			array(
		...
		$wp_customize->selective_refresh->add_partial( 'header_extra_text',
			array(
		...
		$wp_customize->add_control( new Mtm_TinyMCE_Custom_control( $wp_customize, 'footer_text',
			array(
	...
	public function mtm_register_search_controls( $wp_customize ) {
		// Add our Checkbox switch setting and control for opening URLs in a new tab
		$wp_customize->add_setting( 'header_search_bar',
			array(
		...
		$wp_customize->add_control( new Mtm_Toggle_Switch_Custom_control( $wp_customize, 'header_search_bar',
			array(
		...
		$wp_customize->selective_refresh->add_partial( 'header_search_bar',
			array(
	...
	*/
	public function mtm_register_special_page_controls( $wp_customize ) {
		...
		$wp_customize->add_setting( 'custom_error_page',
			array(
		...
		$wp_customize->add_control( new Mtm_Dropdown_Posts_Custom_Control( $wp_customize, 'custom_error_page',
			array(
		...
		$wp_customize->add_setting( 'error_page_search_bar',
			array(
		...
		$wp_customize->add_control( new Mtm_Toggle_Switch_Custom_control( $wp_customize, 'error_page_search_bar',
			array(
				'label' => __( 'Display search bar', 'mtm' ),
